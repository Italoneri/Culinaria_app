// Recipe data + shared design tokens for Saveur

window.SAVEUR_TOKENS = {
  bg: '#0D0D0D',
  card: '#1A1A1A',
  cardElev: '#222222',
...
// Unsplash hotlinks — high-quality food photography
window.SAVEUR_RECIPES = [
  {
    id: 'r1',

...
| Backend | Hono (Node.js, Bun runtime) | Leve, tipado, edge-ready; API REST em `apps/api/` |
...
│   │   │   └── types.ts            # Tipos derivados do schema do banco
│   │   ├── public/
│   │   │   ├── manifest.json       # PWA manifest
│   │   │   └── sw.js               # Service worker
│   │   └── next.config.ts
│   └── api/                        # Hono API (opcional — Supabase cobre maioria dos casos)
│       ├── src/
│       │   ├── routes/
│       │   │   ├── recipes.ts
│       │   │   ├── users.ts
...
- [ADR-0002](docs/adr/ADR-0002-stack-backend.md) — Stack backend: Hono + Bun
